...
/**
 * This is the second version of the npartite subgraph.
 * @author penpen926
 */
public class NpartiteSubgraph extends Subgraph implements Comparable<NpartiteSubgraph>{
    /* The supergraph. */
    NpartiteGraph supergraph = null;
    
    public NpartiteSubgraph(ArrayList<Vertex> subVertices, 
